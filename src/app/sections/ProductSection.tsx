    ...
    return (
        <>
            <p className="explanation">
                Filter by category on the left side or search a specific product
                ...
                <div className="cards-container">
                    <div className="card">
                        ...
                        <div className="colors">
                            ...
                            <label className="radio-container blue">
                                <input
                                    id="radio-blue"
                                    type="radio"
                                    value="3"
                            ...
                            <label className="radio-container yellow">
                                <input
                                    id="radio-yellow"
                                    type="radio"
                                    value="4"
                    ...
                    <div className="card">
                        ...
                        <div className="colors">
                            <label className="radio-container pink">
                                <input
                                    id="radio-pink"
                                    type="radio"
                                    value="1"
                            ...
                            <label className="radio-container purple">
                                <input
                                    id="radio-purple"
                                    type="radio"
                                    value="2"
                    ...
                    <div className="card">
                        ...
                        <div className="colors">
                            ...
                            <label className="radio-container turquoise">
                                <input
                                    id="radio-turquoise"
                                    type="radio"
                                    value="2"
